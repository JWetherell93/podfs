...
def getParser():
    ...
    parser.description = textwrap.dedent('''\
            ...
            Optional Arguments:
                ...
                --checkOutput           Compare PODFS output to output from DigitalFilter.py
            ...
            Input Formats:
                OpenFOAMVTK             VTK files generated by OpenFOAM "surfaces" post-processing function object.
                                        Expects file location and name to be of format:
                                            path/time/varName_patchName.vtk
                                        Assumes consistent points across timesteps.

                preCalcDF               PRF files generated by NT's digital filter code, using verbose option to
                                        write out generated velocity fields.

                resume                  Raw format data files written by this package to allow resumption after data
                                        pre-processing step.

            Output Formats:
                OpenFOAM                File format and directory set up for use with "podfsFvPatchField" OpenFOAM
                                        boundary condition.
